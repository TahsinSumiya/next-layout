...
into Reality..!”</p>
  ...
  <h1 className='text-lg md:text-2xl lg:text-6xl w-4/5 text-left text-dark-orange '>Difference Between Businesses With and Without Websites</h1>
     ...
     <svg
                ...
                <p className=' text-xs md:text-md lg:text-xl text-black'> Businesses that do not have a website may appear uncommon in today&apos;s digital world,  
                  it&apos;s like having a closed shop when potential customers are looking to buy. But it&apos;s not all bad news, 
                  some businesses manage to develop without having a digital presence.</p>
      </div>
